...
class TestWarehouse(unittest.TestCase):
    ...
    def test_update_state(self, update_state_mock):
        for state_name in self.state_names:
            self.warehouse.update_state(state_name, self.mock_value)
    ...
    def test_update_state_with_invalid_key(self, update_state_mock):
        with self.assertRaises(ValueError):
            self.warehouse.update_state(self.invalid_state_name, self.mock_value)
        update_state_mock.assert_called_once_with(self.invalid_state_name, self.mock_value)
