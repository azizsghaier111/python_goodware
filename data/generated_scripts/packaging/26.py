...
class Warehouse:
    def __init__(self):
        self.state = {'Efficiency in Shipping & Handling': 0, 'Theft Reduction': 0, 'Reduce Food Waste': 0}
...
class TestWarehouse(unittest.TestCase):
    ...
    def test_update_state(self, update_state):
        warehouse = Warehouse()
        value_returned = warehouse.update_state("Efficiency in Shipping & Handling", 10)
        update_state.assert_called_once_with("Efficiency in Shipping & Handling", 10)
