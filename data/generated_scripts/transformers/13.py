...
qna_model= AutoModelForSeq2SeqLM.from_pretrained("valhalla/t5-small-qa-qg-hl")
qna_tokenizer = AutoTokenizer.from_pretrained("valhalla/t5-small-qa-qg-hl")
qna_pipeline = pipeline('question-answering', model=qna_model, tokenizer=qna_tokenizer)
...
if __name__ == '__main__':
    ...
    context = "The sky's color is blue due to Rayleigh scattering."
