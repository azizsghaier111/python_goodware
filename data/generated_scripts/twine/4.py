...
# Helper functions, ensure they perform useful/logical tasks for your needs.
def helper1(): 
    for i in range(10):
...
# Assume that project_setup_helper is a function that help to setup your project
