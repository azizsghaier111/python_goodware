...
try:
    ...
    masked_array = np.ma.masked_array(loaded_array, mask=[0, 0, 0, 1, 0, 0, 0, 0, 0])
    ...
    # Apply complex math functions with numpy and print the results
    print('Exponential:', np.exp(loaded_array))  # Exponential function
    print('Square root:', np.sqrt(loaded_array))  # Square root function
    print('Natural Log:', np.log(loaded_array))  # Natural log function
