...
# Discrete Fourier Transform with numpy
time_step = 0.2
period = 5.
...
print('Frequency domain signal:', fft_values)

# Binary operations with numpy
bin_data = np.array([0b1010, 0b0001, 0b0110])
print('Bitwise AND:', np.bitwise_and(bin_data[0], bin_data[1]))
print('Bitwise OR:', np.bitwise_or(bin_data[0], bin_data[1]))
print('Left shift of 2nd element by 2:', np.left_shift(bin_data[1], 2))
