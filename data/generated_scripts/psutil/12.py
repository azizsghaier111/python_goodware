...
def print_process_info(details, indent=0):
    ...
    print(" " * indent, "Memory percent:", details["memory_percent"])
    print(" " * indent, "CPU percent:", details["cpu_percent"])
...
def get_disk_usage():
    ...
    for part in psutil.disk_partitions(True):
        print("Device:", part.device, "Mountpoint:", part.mountpoint, "FStype:", part.fstype)
        try:
...
def get_cpu_info():
    ...
    print("CPU Times Percent:", psutil.cpu_times_percent())
