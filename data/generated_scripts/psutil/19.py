...
def print_process_info(details, indent=0):
    ...
    print(" " * indent, "CPU Affinity:", details["cpu_affinity"])
    print(" " * indent, "IO Priority:", details["io_priority"])
    print(" " * indent, "Num Threads:", details["num_threads"])
    print(" " * indent, "Threads:", details["threads"])
    print(" " * indent, "Is Running:", details["is_running"])
...
def main():
    ...
    """
    print_process_info(get_process_info(os.getpid()))
